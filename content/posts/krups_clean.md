...
> ⚠️ **Если вы отключите устройство от розетки во время очистки, нажмёте <i class="demo-icon icon-p"></i> кнопку или в случае сбоя питания, программа очистки будет выполнена с самого начала. В этом случае вам понадобится новая таблетка от накипи. Выполните полный цикл очистки, чтобы обеспечить надлежащий уход за машиной.
